...
>
  ...
  <Body>
    <Select
      id="bulkTriageMessageTaskInput"
      allowCustomValue={true}
      customValidation="{{ bulkTriageMessageRetrieveTask.data?.data?.detail }}"
    ...
    >
      <Event
        ...
        params={{
          ordered: [
            {
              src: "bulkTriageMessageRetrieveTask.reset();\nbulkTriageMessageRetrieveTask.trigger();",
            },
          ],
        }}
        pluginId=""
